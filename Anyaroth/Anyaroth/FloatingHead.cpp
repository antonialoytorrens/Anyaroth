...
FloatingHead::FloatingHead(Game* g, Player* player, Vector2D pos, BulletPool* pool) : Enemy(g, player, pos, g->getTexture("FlyingHead"), "turretDeath", "turretHit", "turretMeleeHit"), StaticFlyingEnemy(g, player, pos, pool)
{
	_life = 80;
